...
function SignUp() {
  return (
      <div>
          <div className='text-2xl mt-8  font-semibold'>Start your list</div>
          <div className='mt-2' > <p className='font-sans text-gray-500 text-sm'>Free forever. No credit card.</p></div>
